...
from irides.design.digital import polyema_inline_slope as design_pema
from irides.design.digital import bessel_inline_slope as design_bssl
from irides.design.digital import mbox_inline_slope as design_mbox

from irides.filter_signatures.digital import polyema_inline_slope as f_sig_pema
from irides.filter_signatures.digital import bessel_inline_slope as f_sig_bssl
from irides.filter_signatures.digital import mbox_inline_slope as f_sig_mbox
...
class TestInlineSlopeFilters(unittest.TestCase):
    """
    Parameterized, common unit tests for inline slope filters.
    """
